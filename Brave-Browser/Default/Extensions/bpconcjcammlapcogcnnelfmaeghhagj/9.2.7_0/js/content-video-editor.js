...
(function () {
    ...
    window.nsc_content_video_editor = {
        ...
        history: {
            ...
            removeAll: function () {
                nsc_content_video_editor.history.memory.splice(0, nsc_content_video_editor.history.memory.length);
            },
            draw: function () {
        ...
        event: {
            on: function () {
                ...
                nsc_content_video_editor.canvas.common.container.on('nimbus-editor-active-tools', function (e, tool) {
                    ...
                    if (nsc_content_video_editor.draw[tool] !== undefined && tool !== 'clearAll') {
