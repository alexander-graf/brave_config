...
$(document).on('ready_redactor', function () {
    ...
    $resize_form.find('button').on('click', function () {
        $resize_form.closest('.nsc-panel-dropdown').addClass('nsc-hide').trigger('hide');
    });
    ...
    $("#nsc_redactor_crop").on('click', function () {
        ...
        canvas.width = size.w * zoom;
        canvas.height = size.h * zoom;
        // ctx.fillStyle = '#fff';
        ...
        // $('.nsc_canvas').addClass('nsc_crop');
        //
        // const image = document.getElementById('canvasfon');
        // console.log(image)
    ...
    $("#nsc_redactor_undo_all").on('click', function () {
        ...
        nimbus_screen.canvasManager.loadBackgroundImage(nimbus_screen.info.file.image.patch);
    });
