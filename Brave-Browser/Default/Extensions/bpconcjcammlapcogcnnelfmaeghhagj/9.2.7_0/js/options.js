...
$(document).ready(async function () {
    ...
    //
    // $('#nsc_settings_usage_text').text('Used: ' + window.nimbus_core.formatBytes(storage.used) + ' (' + Math.floor(percent * 100) / 100 + '%)' + ' Quota: ' + window.nimbus_core.formatBytes(storage.quota));
