            ...
            view: {
                ...
                border: function (elem) {
                    ...
                    $('#nsc_capture_fragment_box').css({
                        ...
                        width: window.captureFragmentScroll.data.position.width - 9,
                        height: window.captureFragmentScroll.data.position.height - 9
                    });
                },
                button: function (elem) {
                    ...
                    if ((window.captureFragmentScroll.data.position.height + window.captureFragmentScroll.data.position.y + 60) > window.innerHeight) {
                    ...
                    if (window.captureFragmentScroll.data.position.width < 325) ns_crop_more.css({'bottom': '0', 'top': 'auto'});
                    ...
                    $("html, body").animate({scrollTop: window.captureFragmentScroll.data.position.y + window.captureFragmentScroll.data.position.height - window.innerHeight + 100}, "slow");
                }
            },
            init: function () {
